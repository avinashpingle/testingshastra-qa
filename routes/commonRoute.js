...
router.get("/course/ui-ux-developer", function (req, res, next) {
  res.render("pages/uiuxdeveloper", {
    title: "Testing Shastra | Contact Us | Get In Touch | Address",
  });
});

router.get("/course/manual-testing", function (req, res, next) {
  res.render("pages/mannual-course", {
    title: "Testing Shastra | Contact Us | Get In Touch | Address",
  });
});
